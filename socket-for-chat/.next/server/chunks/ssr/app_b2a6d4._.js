...
function Page() {
    ...
    const formSubmit = (event)=>{
        ...
        try {
            fetch(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$register$2f$page$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_API_URL"] + '/login', {
                method: 'POST',
                headers: {
                    'Content-type': 'application/json'
                },
...
//# sourceMappingURL=app_b2a6d4._.js.map